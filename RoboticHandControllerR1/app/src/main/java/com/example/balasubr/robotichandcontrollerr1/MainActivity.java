package com.example.balasubr.robotichandcontrollerr1;
...
public class MainActivity extends AppCompatActivity {
    ...
    ToggleButton tb1, tb2, tb3, tb4, tb5, tb6, tb7, tb8, tb9;
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("index open")){
                        result.append("Opening FORE");
                        int tmpInt = 14;
                        String tmpStr = String.valueOf(tmpInt);
                        send(tmpStr);
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("index close")){
                        result.append("Closing FORE");
                        int tmpInt = 24;
                        String tmpStr = String.valueOf(tmpInt);
                        send(tmpStr);
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("pinch on")){
                        result.append("Pinch On");
                        int tmpInt = 10;
                        String tmpStr = String.valueOf(tmpInt);
                        send(tmpStr);
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("pinch off")){
                        result.append("Pinch Off");
                        int tmpInt = 25;
                        String tmpStr = String.valueOf(tmpInt);
                        send(tmpStr);
                        tb8.setChecked (true);
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("point on")){
                        result.append("Point On");
                    ...
                    if (speachInput.get(0).equalsIgnoreCase("point off")){
                        result.append("Point Off");
                        int tmpInt = 25;
                        String tmpStr = String.valueOf(tmpInt);
                        send(tmpStr);
                        tb9.setChecked (true);
